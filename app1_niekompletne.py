...
def main():
	...
	st.set_page_config(page_title="Aplikacja")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://cdn.newsapi.com.au/image/v1/c24382b4abfe631978e5ff98d4199a21?width=1280")

	with overview:
		st.title("Aplikacja - sprawdż czy przeżyjesz na Titanicu")
